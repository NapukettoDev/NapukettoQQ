...
- @napuketto/cli@0.1.21

## 0.2.44

### Patch Changes

- @napuketto/cli@0.1.20
...
- ff530e1: fix(create-napukettoqq): 适配 `@clack/prompts` 1.8 的类型守卫变更
...
- Updated dependencies [9b92ca5]
  - @napuketto/cli@0.1.13
...
- @napuketto/cli@0.1.11

## 0.2.33

### Patch Changes

- @napuketto/cli@0.1.10
